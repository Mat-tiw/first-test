...
const Footer = () => {
  return (
    <React.Fragment>
      <div className="flex flex-col items-center bg-stone-200 rounded-tr-2xl rounded-tl-2xl mx-10 sm:mx-20 lg:mx-32 p-4">
        <h1 className="font-bold text-2xl lg:mt-16 md:mt-10 sm:mt-5 mt-5 ">FOOTER</h1>
